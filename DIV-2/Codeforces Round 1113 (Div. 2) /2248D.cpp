...
void MANI(){ 
    ...
    vector<int> pre00(n + 1), pre01(n + 1), pre10(n + 1), pre11(n + 1);
    for(ll i=1;i<=n;i++){
            pre00[i] = pre00[i - 1];
            pre01[i] = pre01[i - 1];
            pre10[i] = pre10[i - 1];
    ...
    while(k--){
        ll l,r;cin>>l>>r;
        int c00 = pre00[r] - pre00[l - 1];
            int c01 = pre01[r] - pre01[l - 1];
            int c10 = pre10[r] - pre10[l - 1];
            int c11 = pre11[r] - pre11[l - 1];
            cout << (abs(c01 - c10) <= c00 + c11 ? "YES" : "NO") << '\n';
    }
}
